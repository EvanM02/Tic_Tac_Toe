...
function placeXOrO(squareNumber) {
  ...
  if (!selectedSquares.some((element) => element.includes(squareNumber))) {
    ...
    if (activePlayer === "X") {
      ...
      select.style.backgroundImage = 'url("images/X1_crop.png")';
      // Active player is equal to "X" the x.png is placed in HTML
    } else {
      // If activePlayer is equal to "O" the O.png is placed in HTML
      select.style.backgroundImage = 'url("images/O1_crop.png")';
    }
    ...
    if (activePlayer === "O") {
      ...
      disableClick();
      //This function waits 0.5 second before placing the image
      // and enabling click
      setTimeout(function () {
        computersTurn();
      }, 500);
  ...
  function computersTurn() {
    ...
    let pickASquare;
    //this condition allows our while loop ot keep
...
function checkWinConditions() {
  ...
  // O 6, 4, 2 condition
  else if (arrayIncludes("6O", "4O", "20")) {
    drawWinLine(100, 508, 510, 90);
  }
  // O 0, 4, 8 condition
...
function disableClick() {
  // This makes our body un clickable
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
  ...
  // This line disallows clicking while the win is playing
  disableClick();
  // This line plays the win sounds
  audio("./Media/win game_2.mp3");
  // This line calls our main animation loop
  animateLineDrawing();
  // This line waits 2 second
